            ...
            <div className="p-6 space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  {featureCount > 0 && (
                    <span className={`text-sm px-3 py-1 rounded-full ${isFeatureCountValid ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'
                      }`}>
                ...
                <div className="relative">
                  <textarea
                    ...
                    className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[140px] font-mono text-sm transition-all duration-200 ${!isFeatureCountValid && featureCount > 0
              ...
              <div className="pt-6 border-t border-gray-200">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600">Features Required</div>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <div className="text-2xl font-bold text-green-600">97.97%</div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl border border-blue-100 p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Enter exactly 46 normalized feature values separated by commas</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center">
                    <span className="text-sm font-semibold text-blue-600">2</span>
                  </div>
                  <span className="text-gray-700">Ensure count shows "46/46 features" in green</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center">
                    <span className="text-sm font-semibold text-blue-600">3</span>
                  </div>
                  <span className="text-gray-700">Click "Run Prediction" to analyze the sample</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-2xl border border-violet-100 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-blue-600">46</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-700">Normalization</span>
                  <span className="font-bold text-green-600">-1 to 1</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-700">Model Input</span>
                  <span className="font-bold text-purple-600">1D → 2D</span>
                </div>
              </div>
            ...
            <div className="p-6">
              {prediction ? (
                <div className="space-y-8 animate-in slide-in-from-bottom">
                  ...
                  <div className="text-center">
                    <div className="inline-flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-gray-900 mt-1">{prediction.prediction}</p>
                      </div>
                    </div>
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-gray-100 to-gray-50">
                  ...
                  {/* Feature Analysis */}
                  <div className="pt-6 border-t border-gray-200">
                    <h4 className="font-semibold text-gray-900 mb-3">Feature Analysis</h4>
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div className="bg-gray-50 p-3 rounded-lg">
                        <div className="text-gray-600">Input Features</div>
                        <div className="font-bold">46 values</div>
                      </div>
                      <div className="bg-gray-50 p-3 rounded-lg">
                        <div className="text-gray-600">Model Input</div>
                        <div className="font-bold">1×46 tensor</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center py-12">
                  <div className="mx-auto w-20 h-20 rounded-full bg-gradient-to-r from-blue-100 to-violet-100 flex items-center justify-center mb-6">
