...
const ModelInfo = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-violet-600 to-purple-600 dark:from-blue-700 dark:via-violet-700 dark:to-purple-700 p-8 text-white shadow-xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-100 dark:text-blue-200 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {performanceMetrics.map((metric, index) => {
          ...
          return (
            <div key={index} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 shadow-sm hover:shadow-md transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <div className={`p-2 rounded-lg bg-gradient-to-r ${gradientColors[metric.color]} bg-opacity-10`}>
                  <Icon className="h-5 w-5 text-white" />
                </div>
                <span className={`text-xs font-medium px-2 py-1 rounded-full ${colorClasses[metric.color]}`}>
                  {metric.name}
                </span>
              </div>
      ...
      {/* 🌳 HYBRID ARCHITECTURE - TREE STRUCTURE 🌳 */}
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8 shadow-sm overflow-x-auto">
        <div className="flex items-center gap-3 mb-10">
          <div className="p-3 rounded-xl bg-gradient-to-r from-blue-500/10 to-violet-500/10 dark:from-blue-500/20 dark:to-violet-500/20">
            <Workflow className="h-7 w-7 text-blue-600 dark:text-blue-400" />
          </div>
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Hybrid Architecture Design</h2>
        ...
        {/* Tree Container */}
        <div className="relative min-h-[700px] w-full flex flex-col items-center">
          
          {/* ===== LEVEL 1: ROOT ===== */}
          <div className="relative z-20 mb-16">
            <div className={`p-6 rounded-2xl bg-gradient-to-r ${gradientColors.blue} text-white shadow-xl w-72`}>
          ...
          {/* ===== LEVEL 2: BRANCHING (CNN + ConvNeXt) ===== */}
          <div className="relative w-full flex justify-center items-start mb-16">
            ...
            <div className="relative flex-1 flex justify-end pr-12">
              <div className="relative">
                {/* Horizontal line from root to left branch */}
                ...
                <div className={`p-5 rounded-xl bg-gradient-to-r ${gradientColors.emerald} text-white shadow-lg w-64`}>
                  ...
                  <div className="space-y-1.5">
                    {architectureLayers[1].components.map((comp, idx) => (
            ...
            {/* Right Branch - ConvNeXt */}
            <div className="relative flex-1 flex justify-start pl-12">
              <div className="relative">
                {/* Horizontal line from root to right branch */}
                ...
                <div className={`p-5 rounded-xl bg-gradient-to-r ${gradientColors.violet} text-white shadow-lg w-64`}>
                  ...
                  <div className="space-y-1.5">
                    {architectureLayers[2].components.map((comp, idx) => (
                      <div key={idx} className="text-xs bg-white/20 rounded-lg px-2 py-1">
                        {comp}
                      </div>
                    ))}
                ...
                {/* Downward connector from ConvNeXt */}
                <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
                  <div className="w-0.5 h-8 bg-gradient-to-b from-violet-500 to-transparent"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative mb-16">
            ...
            {/* Downward connector */}
            <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
              <div className="w-0.5 h-8 bg-gradient-to-b from-amber-500 to-indigo-500"></div>
            </div>
          </div>
          ...
          <div className="relative mb-16">
            <div className={`p-6 rounded-xl bg-gradient-to-r ${gradientColors.indigo} text-white shadow-xl w-80 mx-auto`}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-lg font-bold">Feature Fusion Layer</h4>
              </div>
            ...
            {/* Downward connector */}
            <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
              <div className="w-0.5 h-8 bg-gradient-to-b from-indigo-500 to-rose-500"></div>
            </div>
          </div>

          {/* ===== LEVEL 5: CLASSIFICATION HEAD ===== */}
          <div className="relative">
        ...
        {/* Legend */}
        <div className="mt-24 pt-6 border-t border-gray-200 dark:border-gray-800">
          <h4 className="font-bold mb-4 text-center text-gray-900 dark:text-white">Architecture Flow Legend</h4>
          <div className="flex flex-wrap justify-center gap-6">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-blue-500"></div>
              <span className="text-sm text-gray-700 dark:text-gray-300">Input Processing</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-emerald-500"></div>
              <span className="text-sm text-gray-700 dark:text-gray-300">CNN Feature Extraction</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-violet-500"></div>
              <span className="text-sm text-gray-700 dark:text-gray-300">ConvNeXt Blocks</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-amber-500"></div>
              <span className="text-sm text-gray-700 dark:text-gray-300">Attention Mechanism</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-indigo-500"></div>
              <span className="text-sm text-gray-700 dark:text-gray-300">Feature Fusion</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-rose-500"></div>
              <span className="text-sm text-gray-700 dark:text-gray-300">Classification Head</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-3 rounded-xl bg-gradient-to-r from-blue-500/10 to-cyan-500/10 dark:from-blue-500/20 dark:to-cyan-500/20">
              <Server className="h-6 w-6 text-blue-600 dark:text-blue-400" />
            </div>
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Technical Specifications</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">System requirements and configuration</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {technicalSpecs.map((spec, index) => {
              ...
              return (
                <div key={index} className="flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800">
                      <Icon className="h-4 w-4 text-gray-700 dark:text-gray-400" />
                    </div>
          ...
          {/* Model Size Card */}
          <div className="mt-6 p-5 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-100 dark:border-indigo-800">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Compressed Model Size</p>
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-gray-900 dark:text-white">28</span>
                  <span className="text-lg font-semibold text-gray-700 dark:text-gray-300">MB</span>
                </div>
                <p className="text-xs text-gray-500 dark:text-gray-500">Optimized for edge deployment</p>
              </div>
            </div>
          </div>
        </div>

        {/* Attack Categories - SCROLLABLE VERSION */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-xl bg-gradient-to-r from-red-500/10 to-orange-500/10 dark:from-red-500/20 dark:to-orange-500/20">
                <Shield className="h-6 w-6 text-red-600 dark:text-red-400" />
              </div>
              <div>
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Attack Categories</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">14 attack types + normal traffic</p>
              </div>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-lg">
              <Database className="h-4 w-4 text-gray-600 dark:text-gray-400" />
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{attackCategories.length} types</span>
            </div>
          </div>

          {/* Scrollable Attack List - Custom Scrollbar */}
          <div className="relative">
            ...
            <div className="max-h-[400px] overflow-y-auto pr-2 space-y-3 custom-scrollbar">
              {attackCategories.map((attack, index) => (
                <div 
                  key={index} 
                  className="p-4 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-red-300 dark:hover:border-red-700 hover:bg-red-50/30 dark:hover:bg-red-900/10 transition-all duration-200 group"
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                      <div className={`w-2.5 h-2.5 rounded-full ${colorClasses[attack.color]}`}></div>
                      <span className="font-medium text-gray-900 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white">
                        {attack.name}
                      </span>
                    </div>
                    <span className={`text-xs px-2.5 py-1 rounded-full font-medium ${colorClasses[attack.color]}`}>
                      {attack.severity}
                    </span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-gray-400 dark:text-gray-500">Severity</span>
      ...
      {/* Dataset Information */}
      <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 rounded-2xl border border-blue-100 dark:border-gray-800 p-6 shadow-sm">
        <div className="flex items-center gap-4 mb-6">
          <div className="p-3 rounded-xl bg-white dark:bg-gray-800 shadow-sm">
            <Database className="h-6 w-6 text-blue-600 dark:text-blue-400" />
          </div>
          <div>
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Dataset: CICIoT2023</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Comprehensive IoT network traffic dataset</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Network Features</div>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">3.5M</div>
            <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Total Samples</div>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            <div className="text-2xl font-bold text-red-600 dark:text-red-400">14</div>
            <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Attack Types</div>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">105</div>
            <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">IoT Devices</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
        <h2 className="text-2xl font-bold mb-6 text-center text-gray-900 dark:text-white">Architecture Advantages</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 rounded-xl bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-800 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 rounded-lg bg-gradient-to-r from-blue-500/10 to-cyan-500/10 dark:from-blue-500/20 dark:to-cyan-500/20">
                <Network className="h-5 w-5 text-blue-600 dark:text-blue-400" />
              </div>
              <h3 className="font-bold text-gray-900 dark:text-white">Multi-Scale Features</h3>
            </div>
          ...
          <div className="p-5 rounded-xl bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-800 hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-300">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 rounded-lg bg-gradient-to-r from-emerald-500/10 to-green-500/10 dark:from-emerald-500/20 dark:to-green-500/20">
                <Zap className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
              </div>
              <h3 className="font-bold text-gray-900 dark:text-white">Real-time Performance</h3>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="p-5 rounded-xl bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-800 hover:border-violet-300 dark:hover:border-violet-700 transition-all duration-300">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 rounded-lg bg-gradient-to-r from-violet-500/10 to-purple-500/10 dark:from-violet-500/20 dark:to-purple-500/20">
                <Brain className="h-5 w-5 text-violet-600 dark:text-violet-400" />
              </div>
              <h3 className="font-bold text-gray-900 dark:text-white">Robust Detection</h3>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              97.97% accuracy across 14 diverse attack types with minimal false positives
            </p>
          </div>

          <div className="p-5 rounded-xl bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-800 hover:border-amber-300 dark:hover:border-amber-700 transition-all duration-300">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 rounded-lg bg-gradient-to-r from-amber-500/10 to-orange-500/10 dark:from-amber-500/20 dark:to-orange-500/20">
                <HardDrive className="h-5 w-5 text-amber-600 dark:text-amber-400" />
              </div>
              <h3 className="font-bold text-gray-900 dark:text-white">Lightweight</h3>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              28MB model size with only 0.0373M parameters for edge deployment
            </p>
          </div>
        </div>
      </div>
